...
We study how accurately individuals identify productive peers across different skill dimensions. In a lab-in-the-field experiment with 849 university students, we collected incentivized measures of cognitive and social skills from all participants, then asked them to make referrals for each skill among their classmates. We incentivized referrals based on the nominee's measured productivity in the specific skill. We find that peers can successfully identify cognitive skills but not social skills of their classmates. When referring the same classmates across skills, participants rely on academic performance rather than measured skills. To examine potential social class barriers, we randomly assigned half the participants to receive additional incentives for identifying high-skilled peers from lower social classes. We find limited evidence of bias against lower social class peers, and the quota-like incentives helps mitigate it. These findings suggest that the accuracy of peer assessments varies substantially across different skill dimensions even with sustained interaction and performance incentives.
\medskip \\
