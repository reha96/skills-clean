...
twoway (histogram pcent_count_rav_t1, percent width(8) color(eltblue%80)) ///
       (histogram pcent_count_eye_t1, percent width(8) fcolor(none) lcolor(orange)), ///
...
(scatter rank_pcent_count_rav_t1 pcent_count_rav_t1 , ///
    ...
    xtitle("Percent referral share") ///
    legend(ring(0) pos(11) order(1 2) label(1 "Cognitive") label(2 "Social") rows(2) size(small) region(lcolor(none) fcolor(none))) ///
    $graph_opts
...
twoway (histogram same_and_own, percent start(-0.5) width(`width') color(eltblue%80)) ///
       (histogram same_referral, percent start(-0.5) width(`width') fcolor(none) lcolor(orange)), ///
       xlabel(0(1)3) ///
...
// Modified histogram with offset
twoway (histogram pcent_twice_t1, percent width(6) color(eltblue%80)) ///
	   (histogram pcent_single_eye_t1, percent width(6) fcolor(none) lcolor(forest_green)) ///
       (histogram pcent_single_rav_t1, percent width(6) fcolor(none) lcolor(orange)), ///
       legend(ring(0) pos(2) order(1 3 2)  label(1 "Twice") label(3 "Cognitive only") label(2 "Social only") rows(3) size(small) region(lcolor(none) fcolor(none))) ///
       xtitle("Percent referral share") ///
       ytitle("Percent") ///
       ylabel(, angle(0)) ///
       xsize(4) ///
