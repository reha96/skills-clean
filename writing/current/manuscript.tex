...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.6\linewidth}
      ...
      \label{fig:social}
  \end{subfigure}
  \caption*{\footnotesize\textit{Note:} Figures show the respective distribution of cognitive and social skills across SES. High social class outperform Low-SES in both skills ($t$ tests have $p$ values $< 0.001$). We can visually verify that larger share of high-SES in quantiles above median for both skills.}
\end{figure}
