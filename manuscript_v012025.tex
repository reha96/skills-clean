...
Referrals are an important channel for connecting workers with firms, transmitting valuable skill information to form good matches. Approximately half of all jobs are filled through referrals \citep{topa2011labor}, and referred workers tend to earn higher wages, have longer tenure, and are more likely to be hired than non-referred candidates.\footnote{See \citet{topa2019social} for a review of the literature. Examples include \citet{brown2016informal, bayer2008place, hellerstein2014labor, hellerstein2019labor, schmutte2015job, dustmann2016referral,friebel2023employee}.} Referral hiring can also propagate inequality due to its inherent reliance on networks \citep{bolte_role_2021,jackson2021inequality}, with lower social classes especially at the risk of being left out \citep{stansbury2024class,chetty2022social_a}.

Yet the precise mechanisms driving how and when referrals provide positive information about worker quality are still not well understood. Skilled workers may know other skilled workers, and refer them as a consequence of their network composition \citep{montgomery_social_1991}. Alternatively, given the network composition, certain workers may be better at screening productivity, with screening ability depending on the skill in question. Existing empirical work focuses on naturalistic settings with endogenous network formation, making it difficult to disentangle screening ability from network composition effects (e.g., \citet{beaman_who_2012,pallais_why_2016}). In this paper, we focus on the latter and ask two questions: Can individuals identify productive peers across different skills when network compositions are held constant? Second, because referrals are prone to biases \citep{beaman_job_2018}, do disadvantaged individuals from lower social classes still face referral barriers when network and performance differences are accounted for?

We conducted a lab-in-the-field experiment in a private Colombian university to answer these questions. Participating bachelor students were asked to refer classmates they interacted with throughout the semester in small classrooms (average 26 students per class). This particular setting allowed us to to fix network compositions and made referral choice sets fully observable to researchers. We first collected incentivized cognitive and social skill measures, and then asked for private nominations of the referral candidates. Referred students did not take any action, and with incentives contingent on referral performance we ruled out concerns of potential social transfers (i.e., nepotism or favoritism) or reputational costs. Once we asbtracted away from these elements, the referral exercise resembled to one of measuring productivity beliefs through nominated candidates where biases against lower social classes could still be at play. We introduced quota-like incentives as a treatment arm to increase referrals and mitigate these potential biases.  

We find that referrers can screen for cognitive but not for social skill. Our empirical strategy consists of normalizing the number of referrers across classrooms and comparing the shares of referrals a participant receives in each skill. Students with higher scores on the cognitive skill measure get more referrals, but we find no evidence that social skill can be screened effectively in the same way. Referral hiring may help identifying some skills but not others depending on the context. Crucially, we find that a large majority of referrers screen for academic performance instead: Students with better grades get a substantially higher share of referrals when controlling for either skill. Participants have differential referral strategies that either focus on screening for GPA only, screening for GPA and cognitive skill, or neither of the two. The ability to screen for grades in our sample is better than the ability to screen for skills. Our findings highlight that referrals do convey positive information, but the type of information being conveyed is nuanced and may not necessarily match what the firm requires.
% Grades may be an accesible proxy for skills in educational settings if screening for skills are difficult.

The support for a bias affecting lower social classes is limited. Only the group of referrers screening for cognitive skill and GPA  refer a lower share of their low-SES classmates when productivity and network compositions are accounted for. The remaning majority of referrals are not biased, despite our experimental setting in a highly unequal society with significant class inequalities and limited class mobility \citep{angulo2012movilidad,garcia2015loteria}. The treatment partially mitigates the bias for this subset of referrers, while not changing the referral rates of lower social classes in the rest. Heterogeneous ability to identify social class may play a role in the efficiency of the treatment. Our findings show referrals are robust to salient differences between social classes, and provide evidence that existing biases can be remedied with changes in the referral incentive structure.   
...
We contribute to the broader literature on referral experiments, notably about the productivity information transmitted by referrals. Past work provides causal evidence that referrals have higher prodictivity compared to non-referred workers \citep{pallais_why_2016}, especially under incentives contingent on referral performance that reduce social transfers between the referrer and referrals \citep{beaman_who_2012,witte2021workers}. In our setting, performance contingent incentives with fixed networks highlight the screening ability of referrers, which depends on the skill  

demonstrating that alone contains positive information about worker 

Contribution 1: First study fixing networks and eliminating social transfers
Contribution 2: Novel evidence on screening of different skill types
Contribution 3: New insights on SES-based referral patterns in 
overlapping networks


POLICY RELEVANCE (optional)


Implications for understanding skill screening in hiring
Insights for addressing socioeconomic disparities in referral networks
...
It remains an open empirical question whether some workers are connected more often with other productive workers, or given the same network, some referrers are better able to assess the productivity of their network members. We explore a new setup where the networks are fixed for all referrers, and social transfers are not of concern. What constitutes a referral in terms of the intensity of communication and reputational costs as a consequence of social transfers can be thought on a spectrum \citep{topa2019social}.\footnote{On one extreme, letting someone know about a job opening requires no communication between the referrer and the employer with no reputational cost for the referrer. On the other extreme, recommending someone to an employer involves communication between the referrer and the employer, and comes at a large reputational cost for the referrer if the match does not work out.} We consider a very simplified setup where a referral only consists of a private nomination of a network member whose is believed to be highly productive in a given task. There are no referrer-employer interactions and no possibility of social transfers. Once we abstract away from these elements, the referral exercise arguably resembles to one of measuring productivity beliefs through nominated candidates. Understanding how referral decisions are made when the referral choice set is restricted and fully observable to researchers, without reputational costs and social transfers, is our main contribution.

While referral hiring may help increase job-candidate quality through homophily, it also propagates inequality: Employment and wages among friends correlate \citep{calvo2004effects,calvo2007networks} and disadvantage qualified yet underrepresented worker groups \citep{bolte2020role,jackson2021inequality,beaman_job_2018}. Individuals are tied more frequently with those of comparable socioeconomic status \citep{chetty2022social_a}, and differences in network composition lead to persistent differences in labor market outcomes, even when controlling for various productivity measures \citep{stansbury2024class}. Our experiment takes place in a highly unequal society with significant class inequalities and limited class mobility \citep{angulo2012movilidad,garcia2015loteria}, making salient the differences between social classes. Limited interaction across social classes due to spatial segregation is shown to drive at least some of the differences in outcomes \citep{chetty2022social_b}, but we consider a setting where networks across social classes overlap. Anticipating differences in referral outcomes for low-SES even when spatial constraints are removed and productivity is accounted for, we introduce quota-like incentives as a treatment arm to increase referrals of low-SES. We design the treatment incentives in inspiration from the success of gender quotas in the affirmative action literature \citep{bertrand2019breaking, balafoutas2012affirmative, niederle2013costly}.

A growing body of work emphasizes positive labor market returns for ``noncognitive'' or ``soft'' skills like patience, self-control, conscientiousness, teamwork, and critical thinking \citep{heckman2006effects,lindqvist2011labor,heckman2012hard,weinberger2014increasing}. \citet{deming2017growing,deming2023multidimensional} separates these into interpersonal and intrapersonal skills, finding increasing returns to interpersonal (social) skills which are conceptually distinct but complementary to cognitive skill. Based on advances in this literature, we examine how well individuals can identify job-market relevant skills in referrals. Past work show referrers can identify cognitive skill, but not a noncognitive skill like perseverance in a sample of low-educated day-workers in India \citep{beaman_who_2012}. Evidence on social skill identification is limited. Yet, hiring firms report difficulties in observing job applicants' social skills among their most important concerns, and applicants are willing to pay substantial sums to convey social skill feedback to employers \citep{bassi2022screening}. We contribute to this literature by extending productivity screening to a highly educated sample for cognitive and social skills.

We separately measure cognitive and social skills from a diverse student body of peers who interact during semester-long university classes. We find that under performance-contingent incentives, referrers can screen cognitive skill but not social skill, providing another explanation for the large demand for communicating social skill to firms \citep{bassi2022screening}. By fixing network formation and closing social transfer channels, we show that referrals reveal information about worker productivity as suggested by \citet{beaman_who_2012,beaman_job_2018,pallais_why_2016}, but only for skills than can be screened by referrers. We document a novel pattern in referral strategies when clean productivity signals are absent: Referrals often rely on a proxy linked to academic performance rather than the skill, highlighting limitations in precise skill screening. We find that low-SES individuals underperform in both skill measures, consistent with \citet{falk2021socioeconomic}. However, controlling for productivity and network composition, we find limited bias against low-SES. Quota-like incentives improve outcomes for low-SES in the small proportion of cases where the bias exists.

Section 2 begins with the background and setting in Colombia. In Section 3 we present the design of the field experiment, including the skill assessment, referral and guessing tasks. In Section 4 we describe the data and procedures. Section 5 discusses the results of the experiment. Section 6 concludes. The Appendix presents and additional tables and figures as well as the experiment instructions.
...
This normalized measure represents the percentage of potential referrals actually received by each individual, adjusting for classroom size and treatment status. By construction, $y_{i}^s \in [0,100]$ for all $c$, and we can compare referrals across classrooms of different sizes. Figure \ref{fig:referral_fraction_skill} presents the distribution of our dependent variable. 

\begin{figure}[H]
  \centering
  \caption{Referrals received at Baseline}\label{fig:referral_fraction_skill}
  \includegraphics[width=0.85\linewidth]{figures/ref_skill_baseline.png}
  \caption*{\footnotesize\textit{Note:} The figure shows the percentage share of referrals received across cognitive and social skills from participants in Baseline condition. It is calculated as the number of actual referrals received divided by the maximum possible referrals a student could have received.}
  %  To illustrate: Consider a classroom with 25 students with 20 participants, and assume 10 participants in each condition. In this classroom, an individual could receive maximum 10 referrals for a skill from classmates in Baseline condition. This number is 9 if the individual is also in Baseline (exclude 1 self-referral possibility). We normalize the referrals received by the maximum to obtain the percentage share shown in the figure. The distribution of referrals is right-skewed with extreme outliers, with consistency across cognitive and social skills.
\end{figure}
...
\subsubsection*{Referral strategies}
Diversity in referral choices can vary substantially as participants refer 3 individuals per skill, and can nominate the same individual twice. In Figure \ref{fig:same}, we show the share of referrers disaggregated by the number of times a they nominated the same classmate for both skills. Referral choices are highly concentrated around the same individuals: Only 20 percent of participants pick all unique classmates for their 6 referral choices, and most participants make two common referrals. Exluding self-referrals underestimates the share of participants who have 3 identical referral choices, and the diversity in referral choices gets even lower with self-referrals \footnote{In Appendix Table \ref{tab:overlap_ref} we compare the characteristics of referrers make unique referrals to those who made at least one common referral. Results suggest minimal differences in GPA, skills, and social class.} 

\begin{figure}[H]
  \centering
  \caption{Share of common referrals}\label{fig:same}
  \includegraphics[width=0.7\linewidth]{figures/ses_dist3.png}
  \caption*{\footnotesize\textit{Note:} The figure shows the distribution of overlapping referrals with and without self-referrals. The first bar (value of 0) indicates the share of participants with 6 unique referrals. The last bar (value of 3) indicates the share of participants with 3 identical referral choices.} 
\end{figure}
