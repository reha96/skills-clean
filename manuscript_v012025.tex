...
\textbf{Keywords:} behavioral economics, referrals, field experiment, skills, social class
...
We conducted a lab-in-the-field experiment in a private Colombian university to answer these questions. Participating students referred classmates they interacted with throughout the semester in small classrooms (average 26 students per class). The classroom setting provided two advantages. First, students shared the same potential referral candidates -their classmates, and we could observe all possible referral choices. We first collected incentivized cognitive and social skill measures, mapping the performance topography of participants across skills. We then asked for private nominations of the referral candidates. Collecting skill measures before referrals removed the need for the referred students to take any action. We ruled out concerns of potential social transfers (i.e., nepotism or favoritism) or reputational costs with incentives contingent on referral performance. Once we abstracted away from these elements, the referral exercise resembled to one of measuring productivity beliefs through nominated candidates where biases against lower social classes could still be at play. We randomly assigned half of the participants within the same network to pure performance incentives regardless of social class. The other half received additional incentives to identify high-skilled peers from lower social classes, allowing us to assess how well incentives can mitigate biases within the same network. 

We find that referrers can screen for cognitive but not for social skill. By normalizing the number of referrers across classrooms, we compare the shares of referrals a participant receives for each skill. Students with higher scores on the cognitive skill measure get more referrals but we find no evidence that social skill can be screened effectively in the same networks. Crucially, students with better academic performance get a substantially higher share of referrals controlling for either skill. Participants' referral strategies differ: When referrers nominated the same people for both skills, they choose students with higher grades but not higher skills. For cognitive skill nominations, both grades and measured cognitive ability were equally good predictors of who got referred. Referrals for cognitive skill only are predicted equally well by grades and cognitive skill. Remaning referrals for social skill only cannot be predicted by neither academic performance or social skill. These findings reveal a nuanced picture of how referrals convey positive information, depending on how well referrers identify the skill in question.

We find limited support for a bias affecting lower social classes. When accounting for peer skills and classroom composition, we find bias only among referrers who use both cognitive skill and grades in their decisions. The remaining two thirds referrals are not biased. The incentive treatment partially mitigates the bias for this subset of referrers, while not changing the referral rates of lower social classes in the rest. Heterogeneous ability to identify social class may play a role in the efficiency of the treatment. Our findings show referrals are robust to salient differences between social classes, and provide evidence that existing biases can be remedied with changes in the referral incentive structure.   
