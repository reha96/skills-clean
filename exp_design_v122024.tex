...
\title{Skills, Inequality, and Referrals\footnote{We obtained Institutional Review Board approvals from NYU Abu Dhabi (HRPP 2024-50) and the University of Luxembourg (ERP 24–028). The study design was preregistered in the OSF Registries prior to data collection (see \url{https://doi.org/10.17605/OSF.IO/V9T3W}).} }
...
In the absence of a clean skill-signal from their peers, participants may have referred classmates using proxies of skills. We define proxies as peer beliefs about strong correlates for skills. A straightforward proxy for cognitive skills would be the ``good students'' in the classroom, as measured by GPA. However, cognitive skills and grades are far from perfectly correlated \citep{heckman2012hard}, and such beliefs may not be accurate. Indeed, in our sample, GPA correlates very weakly with skills (see Appendix Table \ref{tab:correlation}). We attempt to capture these beliefs by including standardized GPA scores as an independent variable in Equation (\ref{skill}) and re-estimate referral percentage shares $y_{i}^{s}$.

Table \ref{tab:regression-results2} illustrates our findings. The comparison of interest is the difference between point estimates for skills and GPA. In column (1), a one standard deviation increase in cognitive skill causes a 0.9 percentage point increase in the share of referrals received when controlling for GPA. On a base rate of 12.8\%, this is a comparable increase in magnitude of about 7 percent to our previous estimate in Table \ref{tab:regression-results1}, and suggests cognitive skills have an independent effect on referrals. However, a one standard deviation increase in GPA causes a substantial 3.9 percentage point increase in the share of referrals received when controlling for cognitive skill. This is an increase of more than four times in terms of magnitude (30 percent) when compared to cognitive skill, and suggestive of the extent to which academic performance is easier to observe among peers. In column (2), 95\% confidence intervals rule out that a one standard deviation increase in the social skill result in more than a 1 percentage point difference in the share of referrals received. This finding is consistent with our previous estimate where participants cannot identify social skills. On the other hand, a one standard deviation increase in GPA causes a substantial 3.4 percentage point increase in the share of referrals received when controlling for social skill. This is a similar albeit slightly smaller increase of 26 percent in the share of referrals for social skill. For both skills, we find strong evidence that grades act as a proxy for referral decisions. In the subsequent section we expand more on how referral decisions are made.

\begin{table}[H]
  \centering
  \begin{threeparttable}
  \caption{Share of referrals conditional on skill and academic performance}\label{tab:regression-results2}
  \begin{tabular*}{0.85\textwidth}{@{\extracolsep{\fill}}l c c@{}}
  \toprule
  & (1) & (2) \\
  & Cognitive & Social \\
...
Diversity in referral choices vary substantially between participants as they nominate 3 individuals per skill and can make overlapping referrals across skills. In Appendix Figures \ref{fig:same_a} and \ref{fig:same_b}, we show that only 20.5 percent of participants pick all unique classmates for their 6 choices. In fact, depending on our measures, between 50 to 70 percent of participants make at least 2 overlapping referrals and the diversity in referral choices is much lower than anticipated.\footnote{In Appendix Table \ref{tab:overlap_ref} we compare the characteristics of referrers make unique referrals to the remainder of the sample. The results suggest minimal differences in GPA and skills.}

With such a large share overlapping referral choices, it is possible that participants believed classmates with a higher score in one skill would also have a higher score in the other. Would such beliefs be accurate? There is only modest ($\rho = 0.267$) correlation between the two skills (see Appendix Table \ref{tab:correlation}). To understand whether making overlapping referrals is strategic, we turn to the incentives. Participants were incentivized to pick the top 3 performers in their classroom for each skill to earn a fixed bonus. Looking at the characteristics of top skilled participants in Appendix Table \ref{tab:top_perf}, we find that conditional on being among the top 3 for one of the skills, only 1 in 3 participants were in the top 3 for both skills. This suggests making more than 1 overlapping referral choice would decrease the chances to win the bonus. 

A competing explanation for the amount of overlapping referral choices coupled with the notable difficulties in identifying skills would be that individuals who refer classmates twice for both skills are worse at observing peer skills. This imples the underlying heterogeneity in skill identification results in differential referral strategies where participants with a good signal for a skill choose to refer classmates only once for that skill, and those without a good signal use the grade proxy and refer classmates for both skills. We can test both hypotheses in our data: If ``twice'' referrers -defined as those who refer an individual for both skills- are better at identifying at least one of the skills, this gives more credence to beliefs about correlated skills. On the other hand, if ``twice'' referrers are worse in skill identification compared to single-referrers and use GPA proxy for referrals, they have no information about skills. 
...
\begin{equation}
  ...
  \end{equation}
we regress Equation \ref{skill} supplanted with GPA for our three new dependent variables and report our findings in Table \ref{tab:regression-results3}. The comparison of interest is the skill and GPA estimates across columns. In column (1), we find that a one standard deviation increase in GPA causes a 3.2 percentage point increase in the share of ``twice'' referrals received when controlling for skills. This is a staggering 43 percent increase on a base rate of 7.4\%. 95\% confidence intervals rule out that a one standard deviation increase in either skill result in more than a 1 percentage point difference in the share of ``twice'' referrals received. Participants who nominate the same individuals for both skills make referrals based on academic performance and cannot observe classmates with higher cognitive or social skills. For participants who receive only cognitive skill referrals, in column (2), we find that a one standard deviation increase in GPA causes a 0.8 percentage point increase in the share of referrals when controlling for cognitive skill. A one standard deviation increase in cognitive skill causes a comparable 1 percentage point increase in referrals when controlling for GPA. These are respectively 15 and 19 percent increases in the share of referrals received, and suggest participants are able to identify higher skilled peers when referring only for cognitive skill. The lower base rate of 5.4\% compared to 7.4\% in column (1) suggest less than half of referrals came from ``single'' referrals. GPA estimate is three times smaller in magnitude compared to column (1), and is supportive of the smaller weight put in the grades proxy. Nevertheless, the similar magnitudes of GPA and cognitive skill point estimates still suggest participants refer peers with higher grades much more often than the correlation between the two supported by the data ($\rho = 0.085$). There is heterogeneity in skill identification even for those who refer a peer once for cognitive skill. For participants who receive social skill referrals only, in column (3), 95\% confidence intervals rule out that a one standard deviation increase in social skill or GPA result in more than a 1 percentage point difference in the share referrals received. These further support our previous finding that peers cannot identify social skills in our sample, and attempts to identify social skills by ceasing the use of the GPA proxy seems to fail. Taken together, we find that most individuals cannot identify skills in our sample, instead refer using the GPA proxy, and predominantly refer the same individuals for both skills. Those who refer an individual only once for cognitive skill drive the entierity of the results in terms of peer skill recognition. Yet, even these individuals confound the cognitive skill signal with academic performance, and put similar weights on the two characteristic.

\begin{table}[H]
  \centering
  \begin{threeparttable}
  \caption{``Twice'' versus ``single'' referral share conditional on skills and academic performance}\label{tab:regression-results3}
...
\end{equation}
  ...
  It is possible that the effects of social class get diluted in the substantial heterogeneity in referrals. A large proportion of participants -``twice'' referrers- struggle with skill identification and use the academic performance proxy. In our sample we find no SES differences for GPA (see Appendix Figure \ref{fig:gpa}). In fact, past evidence suggests low-SES may even outperform high-SES at the university level in some samples \textcolor{red}{CITE MANU WORK}. When referrals are made with academic performance in mind, there is no particular reason to observe a negative bias against low-SES. How about skills? In our sample high-SES have higher skill scores in both measures (see Appendix Figure \ref{fig:cognitive} and \ref{fig:social}). If individuals who refer only cognitive skills have a clean signal about the skill, it may be reasonable to observe a bias in terms of undersampling from high-performing low-SES. Only then would the Quota treatment be effective in increasing referrals for low-SES. We turn toward our classification of different referral strategies to test this hypothesis. To get clearer estimates for the social class bias and the effects of the Quota treatment on low-SES referrals, we re-estimate the shares of ``twice'' and ``single'' referrals. Following the same logic as before, we observe every participant twice in each specification, and add a treatment dummy to indicate whether the referrals came from referrers in the Baseline or the Quota treatment. We keep the social class dummy and regress Equation \ref{treat-ses-int} for the three dependent variables.

  Table \ref{tab:twice_treat} illustrates our findings. The comparison of interest is the SES of the participant receiving the referrals and the effect of the Quota treatment across ``twice'' and ``single'' referral types. In column (1), for participants who refer the same peers twice using the academic performance proxy, we find no statistically significant effect of participant SES or the Quota on the referrals share when controlling for skills and academic performance. The signs on the point estimates suggest that directionally low-SES get more referrals in the Baseline treatment and that the Quota reduces this share. For participants who make only cognitive skill referrals, in column (2), we find that being low-SES in the Baseline treatment reduces the percentage share of referrals received by 2.1 percentage points when controlling for the skill and academic performance. This is a very large effect size in magnitude, translating to a decrease in referral share by 32 percent on a base rate of 6.6\%. In turn, the Quota treatment increases referrals to low-SES by 1.42 percentage points when controlling for the skill and academic performance. This is also a large effect size that results in an increase in low-SES referral share by 22 percent. For participants who make only social skill referrals, in column (2), we find no statistically significant effect of participant SES or the Quota on the referrals share when controlling for the skill and academic performance. These are in accordance with our previous findings that social skills cannot be identified and provide no reason to warrant social class bias. Taken together, we find support for our hypothesis that there is a bias against low-SES peers for the skill that is well-identified by peers, and in which low-SES underperform. We find no evidence of a bias when referrals are made based on academic performance where both social classes perform equally well. Reassuringly, we find the bias in cognitive skill referrals is at least partially alleviated by the Quota treatment. Because there is remarkable heterogeneity in the ability to detect SES for both social classes (see Appendix Figure \ref{fig:guess}), we find this increase in low-SES referrals satisfying for our sample. In the next section, we explore the possible origins of the social class bias.

  \begin{table}[H]
    \centering
    \begin{threeparttable}
    \caption{Effects of Quota on ``twice'' and ``single'' referral share controlling for skill and academic performance}
...
\begin{figure}[H]
  \centering
  \caption{Referrals in Baseline}\label{fig:referral_fraction_skill}
  \includegraphics[width=0.85\linewidth]{figures/ref_skill_baseline.png}
  \caption*{\footnotesize\textit{Note:} The figure shows the percentage share of referrals received across cognitive and social skills from participants in Baseline condition. It is calculated as the number of actual referrals received divided by the maximum possible referrals a student could have received. To illustrate: Consider a classroom with 25 students with 20 participants, and assume 10 participants in each condition. In this classroom, an individual could receive maximum 10 referrals for a skill from classmates in Baseline condition. This number is 9 if the individual is also in Baseline (exclude 1 self-referral possibility). We normalize the referrals received by the maximum to obtain the percentage share shown in the figure. The distribution of referrals is right-skewed with extreme outliers, with consistency across cognitive and social skills.}
\end{figure}

\begin{figure}[H] \label{fig:same_combined}
  \centering
  \begin{subfigure}[b]{0.48\linewidth}
      \centering
      \caption{Overlapping referrals by treatment}
      \includegraphics[width=\linewidth]{figures/ses_dist.png}
      \label{fig:same_a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\linewidth}
      \centering
      \caption{Overlapping referrals by self-referral}
      \includegraphics[width=\linewidth]{figures/ses_dist3.png}
      \label{fig:same_b}
  \end{subfigure}
  \caption*{\footnotesize\textit{Note:} Figure (a) shows the distribution of overlapping referrals across treatments, and excludes self-referrals. Figure (b) shows the distribution of overlapping referrals with and without self-referrals. The first bar (value of 0) always indicates the share of participants with 6 unique referrals. The last bar (value of 3) always indicates the share of participants with 3 identical referral choices. We find that treatments do not change referral dispersion, but exluding self-referrals significantly underestimates the share of participants who have 3 identical referral choices. In their original referral choices, about 70 percent of our sample had at least 2 common referrals.}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tablenotes}
    \footnotesize
    \item[] {\textit{Note:}  Figure shows the distribution of GPA across SES. There are no significant differences in the mean standardized GPA scores between high-SES (M = 0.065, SD = 1.033, n = 284) and low-SES participants (M = 0.034, SD = 0.971, n = 381), $t$(663) = 0.39, $p$ = 0.695, $d$ = 0.031. }
  \end{tablenotes}
\end{figure}

\begin{figure}[H] \label{fig:skills_combined}
  \centering
  \begin{subfigure}[b]{0.48\linewidth}
      \centering
  ...
  \begin{subfigure}[b]{0.48\linewidth}
      ...
      \label{fig:social}
  \end{subfigure}
  \caption*{\footnotesize\textit{Note:} Figure (a) shows the distribution of cognitive skill across SES. Figure (b) shows the distribution of social skill across SES. For cognitive skill, there are significant differences in the mean standardized scores between high-SES (M = 0.177, SD = 0.956, n = 284) and low-SES participants (M = -0.102, SD = 1.024, n = 381), $t$(663) = 3.58, $p <$ 0.001, $d$ = 0.279. Similarly for mean social skill, there are significant differences between high-SES (M = 0.175, SD = 0.964, n = 284) and low-SES participants (M = $-0.114$, SD = 0.989, n = 381), $t$(663) = 3.76, $p <$ 0.001, $d$ = 0.288. We can visually verify that high-SES are overrepresented in quantiles above median for both distributions.}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tablenotes}
    \footnotesize
    \item[] {\textit{Note:}  Figure shows the distribution of the guessing ability across SES. We calculate the guessing ability as the share of succesful low-SES guesses minus the expected probability of randomly drawing low-SES classmates. A score of 0 indicates random draws, below 0 drawing worse than chance, and above 0 better than chance. There are significant differences in the mean guessing ability between high-SES (M = 0.022, SD = 0.325, n = 271) and low-SES participants (M = 0.093, SD = 0.302, n = 369), $t$(638) = $-2.85$, $p$ = 0.005, $d$ = 0.226. Low-SES participants have significantly higher guessing ability compared to their high-SES counterparts, with a mean difference of 7 percentage points. }
  \end{tablenotes}
\end{figure}
% \begin{figure}[htbp]
%     \centering
...
\begin{table}[H]
  ...
  & (0.983) & (1.009) & \\
  Cognitive Skill & 0.110 & 0.024 & 0.086 \\
  & (1.005) & (0.979) & \\
  Social Skill & -0.014 & 0.033 & -0.047 \\
  & (0.938) & (0.981) & \\
