...
Referrals make up an integral part of the hiring process. Worker and firm surveys find that approximately half of all jobs are found through referrals \citep{topa2011labor}. Their prevalence suggests referrals are an important channel for connecting workers with firms, transmitting valuable information to form good matches. Evidence shows that referrals have a higher probability of getting hired \citep{brown2016informal}, earn higher wages \citep{bayer2008place, hellerstein2014labor, hellerstein2019labor, schmutte2015job, dustmann2016referral}, and are less likely to quit their jobs than non-referred hires \citep{hellerstein2019labor, dustmann2016referral, friebel2023employee}. 

The precise mechanism behind why job-seekers and firms alike resort to referrals remains elusive. One stream of literature originating from \citet{montgomery_social_1991} suggests referrals help solve hiring firms' asymmetric information problem. Firms facing candidates of unknown productivity reduce uncertainty around the quality of a prospective hire via referrals, as highly productive workers bring in highly productive candidates. Granted the assumption of network homophily, a well-documented empirical consistency where individuals form ties more often with others who are similar to themselves across observable characteristics \citep{mcpherson2001birds,mcpherson2006social}, holds between highly productive individuals. Montgomery model conceptualizes how referrals convey information about productivity conditional on endogenous network formation, with supporting experimental evidence finding productivity of referrals being higher than those of non-referred workers \citep{beaman_who_2012,pallais_why_2016}. This result strenghtens when referrals are made under performance contingent incentives as opposed to fixed bonuses which reduces the risk of social transfers (i.e., nepotism or favoritism) between referrer and referee \citep{beaman_who_2012,beaman_job_2018}. Past experiments looked at the referral-referrer productivity relationship keeping the network formation endogenous, with potential social transfer channels between the referrer and referrals \citep{beaman_who_2012,beaman_job_2018,pallais_why_2016,witte2021workers}. These make it difficult to isolate the characteristics of the information channel in referrals.
...
We separately measure cognitive and social skills from a diverse student body of peers who interact during semester-long university classes. Building on \citet{beaman_who_2012}, we find that under performance-contingent incentives, referrers can screen cognitive skill but not social skill, providing another explanation for the large demand for communicating social skill to firms \citep{bassi2022screening}. By fixing network formation and closing social transfer channels, we show that referrals reveal information about worker productivity as suggested by \citet{beaman_who_2012,beaman_job_2018,pallais_why_2016}, but only for skills by referrers. We document a novel pattern in referral strategies when clean productivity signals are absent: Referrals often rely on proxies linked to academic performance rather than the requested skill, highlighting limitations in precise skill screening. We find that low-SES individuals underperform in both skill measures, consistent with \citet{falk2021socioeconomic}. However, controlling for productivity and network composition, we find suprisingly limited bias against low-SES. Heterogeneity analysis reveals that quota-like incentives improve outcomes for low-SES in the small proportion of cases where bias exists.
