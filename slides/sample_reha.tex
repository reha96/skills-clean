...
\title[short title]{Peer skill identification and social class} % The short title appears at the bottom of every slide, the full title is only on the title page
\subtitle{Evidence from a field experiment}

\author[Pin-Yen] {Jhon Díaz - UNAB \newline Manu Munoz - LISER \newline Ernesto Reuben - NYU Abu Dhabi \newline Reha Tuncer - University of Luxembourg}

\date{16 December 2024} % Date, can be changed to a custom date
