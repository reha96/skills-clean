...
qreg pcent_count_rav_t1 c.z_gpa c.z_rav, quantile(90) vce(robust)
est store q90r
qreg pcent_count_rav_t1 c.z_gpa c.z_rav, quantile(75) vce(robust)
est store q75r
qreg pcent_count_rav_t1 c.z_gpa c.z_rav, quantile(50) vce(robust)
est store q50r

qreg pcent_count_eye_t1 c.z_gpa c.z_eye, quantile(90) vce(robust)
est store q90e
qreg pcent_count_eye_t1 c.z_gpa c.z_eye, quantile(75) vce(robust)
est store q75e
qreg pcent_count_eye_t1 c.z_gpa c.z_eye, quantile(50) vce(robust)
est store q50e

esttab  q* ,  b(%12.3f) se(%12.3f) r2 nobaselevels label mtitles star(* 0.10 ** 0.05 *** 0.01)
